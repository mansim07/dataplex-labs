...
| Lab 8 | Data profiling| You will learn how to run data profiling tasks on BigQuery tables to better understand data for cleansing, and analyzing | [ReadMe](../lab8) | 
